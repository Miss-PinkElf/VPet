...
```text
继续 VPet 身体层桥接工作。先读根目录 CONTINUE_VPET_BRIDGE_PROMPT.md 里列出的 state / checkpoints / 最新 handoff / protocol-phase1 / quick-tests，然后直接拉起真实联调链路，优先复测两条核心 sequence 和三条移动单测，不要重新大范围分析。
```
